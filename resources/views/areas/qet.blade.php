...
@section('title', 'Área QET')

@section('content')
<div class="card">
    <h2 style="color:#27ae60;">🔧 Área QET</h2>
    ...
    <div style="background:#f0f4f8; padding:16px; border-radius:6px;">
        <strong>Área asignada:</strong> <span class="area-qet">QET</span>
        <br><br>
        <p style="font-size:14px; color:#555;">
            En esta sección puedes gestionar los neumáticos asignados al área QET.
